        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <div className="w-8 h-8 bg-blue-600 text-white flex items-center justify-center rounded font-bold text-lg">G</div>
              <span className="text-xl font-bold">Gurgao <span className="text-blue-500">Library</span></span>
            </div>
            <p className="text-slate-400 leading-relaxed mb-6">
              Gurgao's leading study library providing a premium environment for aspirants to focus, learn, and succeed. Managed by professionals for the past 5+ years.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400">
              <li className="flex gap-3">
                ...
                <span>1267, New Railway Rd, opp. Fire Station, Dayanand Colony, Sector 6, Gurugram, Haryana 122001</span>
              </li>
              <li className="flex gap-3">
                <i className="fas fa-phone text-blue-500 pt-1"></i>
                <span>+91 9871347495</span>
              </li>
              <li className="flex gap-3">
                <i className="fas fa-envelope text-blue-500 pt-1"></i>
                <span>info@gurgaolibrary.com</span>
              </li>
              <li className="flex gap-3">
